...
::: card
[[A Bayesian modelling framework for health care resource use and costs in trial-based economic evaluations](research/hruZero/hruZero.qmd)]{style="font-size: 1.2rem; font-weight: bold"}

<br/> <br/>

![ ](img/model_diag_template_DI_v2.jpg){fig-align="center" width="80%"}

[Building on the existent literature, we propose a novel Bayesian framework for the modelling of healthcare resource use (HRU) data in trial-based economic evaluations, which allows a flexible model specification and the handling of missing data at HRU level.]{style="font-size: 0.9rem; font-weight: lighter"}

[[{{< fa file-pdf >}}](https://journals.sagepub.com/doi/full/10.1177/0272989X251376026)   [{{< fa file-powerpoint >}}](https://github.com/AnGabrio/Talks/blob/master/Bayes2025/Bayes_2025_v3.pdf)   [{{< fa code >}}](https://github.com/AnGabrio/Code/tree/master/hruZero)]{style="text-align: center; font-size: 2rem"}
:::
